    ...
    return (<div className="w-100 h-100">
        ...
        <Navbar className="shadow bar z-1 position-absolute d-flex flex-row flex-sm-column justify-content-center justify-content-sm-start  align-items-center py-1 px-3 px-sm-1 pt-sm-5  flex-shrink-0 bg-body-tertiary" >
            ...
            <Nav className="flex-sm-column   justify-content-around justify-content-sm-start w-100 h-100">
                <Nav.Link className="text-center ms-sm-3 d-sm-flex justify-sm-start order-1" style={{ height: "60px" }}><i className="bi bi-house"></i>
                    <p className="nav-link-text">Home</p>
                </Nav.Link>
                <Nav.Link className="text-center ms-sm-3 d-sm-flex justify-sm-start order-2" style={{ height: "60px" }}><i className="bi bi-search"></i> <p className="nav-link-text">Pesquisar</p></Nav.Link>
                <Nav.Link className="text-center ms-sm-3 d-sm-flex justify-sm-start order-4 order-sm-3" style={{ height: "60px" }}><i className="bi bi-plus-circle"></i>
                    <p className="nav-link-text">Evento</p>
                </Nav.Link>
                <Nav.Link className="text-center ms-sm-3 d-sm-flex justify-sm-start order-5 order-sm-4 pa-0" style={{ height: "60px" }}><i className="bi bi-bell"></i>
                    <p className="nav-link-text">Notificações</p>
                </Nav.Link>
                <Nav.Link className=" mt-sm-auto  mb-sm-3 order-3 order-sm-5 pa-0 " style={{ height: "60px" }} >
